    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Manage incoming stock from your vendors
                    </p>
                </div>
                {!isLoading && (
                    <AddPurchaseDialog
            ...
            <div className="grid gap-4 sm:grid-cols-3">
                <StatCard
                    label="Total Orders"
                    value={isLoading ? '—' : String(purchases.length)}
                    sub="all time"
                    color="blue"
                    icon={
                ...
                <StatCard
                    label="Total Spend"
                    value={isLoading ? '—' : `₹${totalSpend.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
